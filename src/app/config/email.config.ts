...
export const EMAIL_TEMPLATES = {
  OTP_SUBJECT: 'Your OTP Code - Barangay System',
  FROM_NAME: 'Barangay System',
...
<head>
    ...
    <title>OTP Code - Barangay System</title>
    <style>
        body {
        ...
        .logo {
            background: linear-gradient(135deg, #77867c 0%, #6e756f 100%);
            color: white;
            padding: 20px;
            border-radius: 8px;
            font-size: 24px;
...
<body>
    <div class="container">
        <div class="header">
            <div class="logo">Barangay System</div>
            <h2>Your One-Time Password (OTP)</h2>
        </div>
        
        <p>Hello {{to_name}},</p>
        
        <p>You have requested to log in to the Barangay System. Please use the following One-Time Password (OTP) to complete your login:</p>
        ...
        <div class="footer">
            <p>This is an automated message from the Barangay System.</p>
